...
if (dir.exists(paste0(Results, "rm0")) != T) {
  dir.create(paste0(Results, "rm0"), mode = "0777")
  for (i in method_names) {
    dir.create(paste0(Results, "rm0/", i), mode = "0777")
  }
  dir.create(paste0(Results, "rm1"), mode = "0777")
  for (i in method_names) {
    dir.create(paste0(Results, "rm1/", i), mode = "0777")
  }
  dir.create(paste0(Results, "rm2"), mode = "0777")
  for (i in method_names) {
    dir.create(paste0(Results, "rm2/", i), mode = "0777")
  }
  dir.create(paste0(Results, "rm3"), mode = "0777")
  for (i in method_names) {
    dir.create(paste0(Results, "rm3/", i), mode = "0777")
  }
  dir.create(paste0(Results, "rm5"), mode = "0777")
  for (i in method_names) {
    dir.create(paste0(Results, "rm5/", i), mode = "0777")
  }
  dir.create(paste0(Results, "rm10"), mode = "0777")
  for (i in method_names) {
    dir.create(paste0(Results, "rm10/", i), mode = "0777")
  }
  dir.create(paste0(Results, "rm11"), mode = "0777")
  for (i in method_names) {
    dir.create(paste0(Results, "rm11/", i), mode = "0777")
  }
}
